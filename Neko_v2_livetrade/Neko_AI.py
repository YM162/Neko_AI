API_SECRET_SANDBOX="xxxxx"
API_KEY_SANDBOX="xxxxxx"
...
def comprar(acciones,precio):
    ...
    if "message" in a:
        print("DEV-INFO: Fondos insuficientes")
        return False
    else:    
        return True
...
def comprar_porcentaje(porcentaje,precio): #Gasta un porcentaje de tu dinero en acciones
    ...
    action = comprar(acciones,precio)
    return action
